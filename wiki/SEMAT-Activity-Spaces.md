...
> *Este mapa se ha ido completando progresivamente desde v1.0 hasta v2.1. Cada fase se agrego a la documentacion una vez completada.*
...
>
> **Referencia:** Anteproyecto de Trabajo de Graduacion — Cesar Andres Terrado Gonzalez (2023). Mapa generado progresivamente desde v1.0 hasta v2.1.